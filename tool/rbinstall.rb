...
unless defined?(JRuby) || (defined?(CROSS_COMPILING) and CROSS_COMPILING)
...
module RbInstall
  module Specs
    class FileCollector
      ...
      private
      def type
        /\/(ext|lib\/ruby\/shared|lib)?\/.*?\z/ =~ @base_dir
        $1
      end
      ...
      def ruby_libraries
        ...
        when "lib/ruby/shared"
          base = @base_dir
          prefix = base.sub(/lib\/ruby\/shared\/.*?\z/, "") + "lib/ruby/shared/"
        when "lib"
          base = @base_dir
